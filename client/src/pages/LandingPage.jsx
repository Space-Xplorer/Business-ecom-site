  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-200px)] bg-gradient-to-br from-[#FFF8E1] via-[#FFD700]/20 to-[#F26A1B]/10 relative overflow-x-hidden">
        ...
        <section className="w-full bg-black flex flex-col items-center justify-center mt-15 py-4 border-b-4 border-[#F26A1B] relative z-10 shadow-2xl">
          <div className="w-full max-w-5xl relative">
            <div className="absolute justify-center inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-lg z-10" />
            <Carousel />
          </div>
        </section>
